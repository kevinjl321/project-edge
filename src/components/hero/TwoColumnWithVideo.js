...
const PrimaryButton = tw.button`font-bold px-8 lg:px-10 py-3 rounded bg-gray-300 text-primary-600 hocus:bg-primary-700 focus:shadow-outline focus:outline-none transition duration-300`;
